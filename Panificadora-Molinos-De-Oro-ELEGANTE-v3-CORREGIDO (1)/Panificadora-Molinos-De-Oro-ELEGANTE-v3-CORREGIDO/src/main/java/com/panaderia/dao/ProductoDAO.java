...
public class ProductoDAO {
    ...
    private static final String SQL_LISTAR =
            "SELECT id, nombre, categoria, precio, stock, stock_minimo, descripcion FROM producto ORDER BY id DESC";
    private static final String SQL_BUSCAR_ID =
            "SELECT id, nombre, categoria, precio, stock, stock_minimo, descripcion FROM producto WHERE id=?";
    private static final String SQL_INSERTAR =
            "INSERT INTO producto (nombre, categoria, precio, stock, stock_minimo, descripcion) VALUES (?,?,?,?,?,?)";
    private static final String SQL_ACTUALIZAR =
            "UPDATE producto SET nombre=?, categoria=?, precio=?, stock=?, stock_minimo=?, descripcion=? WHERE id=?";
